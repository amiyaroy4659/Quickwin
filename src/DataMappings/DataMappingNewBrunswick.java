...
public class DataMappingNewBrunswick {
		...
		public static File directory = new File(properties.getPropertyValue("SamplePathNB"));
			...
			public static String createElementDataFetch(String NodeName, String TC_ID, int row, String runManagerPath,
				...
				try {
					...
					case "SubVehicleType" :	
						...
						default : returnVal=VehicleType;break;
						};break;
					...
					case "RatingGroupNumber" :
						...
						colNum = ExcelUtilities.getColNum(log);
						String ratingGroup = ExcelUtilities.getMultiCellDataString(ExcelUtilities.getColumnNum("RatingGroup", colNum),	TC_ID, 1, log, loopToStart);
					...
					case "InsurerName" :
						ExcelUtilities.setExcelFile(runManagerPath, "Policy_TD", log);
						colNum = ExcelUtilities.getColNum(log);
						String insuerer = ExcelUtilities.getMultiCellDataString(ExcelUtilities.getColumnNum("Insuerer", colNum),TC_ID, 1, log, loopToStart);
						returnVal = insuerer;
						break;
					case "TransactionType" :
						returnVal = "NewBusiness";
						break;
					...
					case "EffectiveDate" :
						...
						if (ParentNodeName.equals("DriverInformation")) {
					...
					case "OriginalCreationDate" :
						ExcelUtilities.setExcelFile(runManagerPath, "Policy_TD", log);
						colNum = ExcelUtilities.getColNum(log);					
						returnVal = RandomMethods.dateConvert(ExcelUtilities.getMultiCellDataString(ExcelUtilities.getColumnNum("ClientSinceDate_Auto", colNum), TC_ID, 1, log, loopToStart), log);
						break;
					case "EndDate" :
						ExcelUtilities.setExcelFile(runManagerPath, "Policy_TD", log);
						colNum = ExcelUtilities.getColNum(log);					
					...
					case "DisplayPostalZipCode" :
						...
						colNum = ExcelUtilities.getColNum(log);
						String DisplayPostalZipCode = ExcelUtilities.getMultiCellDataString(ExcelUtilities.getColumnNum("PostalCode", colNum),TC_ID, 1, log, loopToStart);
					...
					case "BirthDate" :
						ExcelUtilities.setExcelFile(runManagerPath, "Driver_TD", log);
						colNum = ExcelUtilities.getColNum(log);
						String Age = ExcelUtilities.getMultiCellDataInt(ExcelUtilities.getColumnNum("Age", colNum), TC_ID, row,	log, loopToStart);
						ExcelUtilities.setExcelFile(runManagerPath, "Policy_TD", log);
						String EffectiveDate = ExcelUtilities.getMultiCellDataString(ExcelUtilities.getColumnNum("EffectiveDate", colNum), TC_ID, 1, log, loopToStart);
